...
const DS: &'static [usize] = &[
    0x00_00_10, 0x00_00_20, 0x00_00_40, 0x00_00_80,
    0x00_01_00, 0x00_02_00, 0x00_04_00, 0x00_08_00,
    0x00_10_00, 0x00_20_00, 0x00_40_00, 0x00_80_00, 
    0x01_00_00, 0x02_00_00, 0x04_00_00, 0x08_00_00, 
    0x10_00_00,
];
...
fn main() {
    ...
    for l in (0..100).map(|i| i*100) {
        let mut agg = AggregateUpdate::<Bls12, Fischlin>::new(1_000);
        for _ in 0..l {
